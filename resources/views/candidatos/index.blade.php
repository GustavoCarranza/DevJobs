                        ...
                        @forelse ( $vacante->candidatos as $candidato )
                            <li class="p-3 flex items-center">
                                ...
                                <div>
                                    ...
                                    class="inline-flex items-center shadow-sm p-3 border border-gray-700 text-sm leading-5 font-medium rounded-full text-gray-700 bg-gray-100 hover:bg-gray-50" target="_blank" rel="noreferrer noopener">
                                        Ver CV
                                    </a>
                                </div>
                            </li>
