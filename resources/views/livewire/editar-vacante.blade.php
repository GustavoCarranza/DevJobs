<form class="md:w-6/12 space-y-5" wire:submit.prevent='editarVacante'>
    ...
    <div>
        ...
        <x-text-input id="imagen" class="block w-full" type="file" wire:model="imagen_nueva" accept="image/*"/>
    </div>
