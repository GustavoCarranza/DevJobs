<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-100 my-10 p-5">
            ...
            <p class="font-bold text-sm uppercase text-gray-800 my-3">Categoria de la vacante:
                <span class="normal-case font-normal">{{$vacante->categoria->categoria}}</span>
            </p>
            <p class="font-bold text-sm uppercase text-gray-800 my-3">Salario de la vacante:
